...
- Business-attractiveness proxy status: `loaded:ine_municipal_population_2025.csv + loaded:ine_provincial_overnight_stays.csv + loaded:existing_interurban_stations_matched.csv + loaded:geoportal_gasolineras_matched.csv`.
